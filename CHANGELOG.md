## 9 — 2025-07-20
- Merge pull request #15 from galagrin/YAUljanenkov-patch-1 (YAUljanenkov)
- Update .gitignore (YAUljanenkov)
- Update Application.tsx (YAUljanenkov)
- Update Application.tsx (YAUljanenkov)
- Update Application.tsx (YAUljanenkov)
- Merge pull request #14 from galagrin/fix-readme (Galina Bobrik)
- fix readme (Galina Bobrik)
